...
export default function UserCard({ userData }) {
  ...
  return (
    <Card className="w-1/3 mt-10 mx-auto px-2">
      <CardHeader>
        <CardTitle className=" className="font-bold text-gray-800 dark:text-white mb-1 text-3xl"">
          {name} {""}({username})
        </CardTitle>
        <CardDescription>
          <p>{email}</p>
      ...
      <CardContent>
        <div className="flex  flex-col gap-2 w-full items-start justify-start">
          <div class="w-full  bg-white px-4 py-3 shadow-lg rounded-lg overflow-hidden my-4  flex justify-around items-center">
            <div className="font-semibold">
              <div className="flex gap-2">
                <p className="text-gray-700 text-3xl"> {company.name} </p>
              </div>
              <div className="flex gap-2">
